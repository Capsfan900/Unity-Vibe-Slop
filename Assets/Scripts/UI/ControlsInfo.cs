namespace VibeGame1
{
    ...
    public static class ControlsInfo
    {
        ...
        public static readonly string Text =
            ...
            "\n" +
            H + "DEV KEYS" + HE + "  (editor and development builds)\n" +
            D + "F1" + DE + "  test menu      " + D + "F5" + DE + "  warp to boss      " + D + "F6" + DE + "  full restore      " + D + "F7" + DE + "  +1000 souls      " + D + "F8" + DE + "  god mode      " + D + "4" + DE + "  dev blade";
    }
}
