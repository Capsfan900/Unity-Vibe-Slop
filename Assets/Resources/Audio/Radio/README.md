...
`Level_01/` currently holds two 8-second **placeholder tones** so the pane is visible out of the box.
Delete them the moment you drop real music in — they are scaffolding, not content.
