...
namespace VibeGame1.Tests
{
    ...
    public class LevelSpan3Tests
    {
        ...
        [Test]
        public void LintelObelisksRecoveryBlocksAndWallsAreGone()
        {
            string[] removed = { "T3_Fallen_Lintel", "T3_Obelisk_W1", "T3_Obelisk_W2", "T3_Obelisk_E1",
            ...
            Assert.AreEqual(0, def.balloons.Length, "the old airborne bypass competes with the mandatory projectile line");
        }
