    ...
    public static class SpellbookFactory
    {
        ...
        public static void CreateAll()
        {
            ...
            GameObject orbCore = Prim(PrimitiveType.Sphere, "SpellOrbCore", visual.orbAnchor, Vector3.zero,
                Vector3.one * 0.076f, itemGlow, Vector3.zero);
            orbCore.name = "TipSpellOrbCore";
            ...
            for (int i = 0; i < runeCount; i++)
            {
                ...
                Vector3 runePosition = new Vector3(Mathf.Cos(radians) * runeRadius,
                    Mathf.Sin(radians) * runeRadius, 0.003f);
                Transform runePivot = Empty("FloatSpellRune" + i, visual.orbAnchor, runePosition);
                GameObject rune = Prim(PrimitiveType.Cube, "TipSpellRune" + i, runePivot,
                    Vector3.zero,
            ...
            visual.orbGlow = visual.orbAnchor.gameObject.AddComponent<EnergyGlow>();
            visual.orbGlow.brightness = 1f;
            visual.orbGlow.baseIntensity = 0.82f;
            visual.orbGlow.pulseAmplitude = 0.18f;
            visual.orbGlow.pulseSpeed = 1.05f;
            visual.orbGlow.flowEnabled = false;
            visual.orbGlow.tipBoost = 1f;
            visual.orbGlow.moteCount = 4;
            visual.orbGlow.moteRadius = 0.085f;
            visual.orbGlow.moteSize = 0.012f;
            visual.orbGlow.moteDriftSpeed = 1.15f;
            visual.orbGlow.orbitSpeed = 44f;
            visual.orbGlow.bobAmount = 0.008f;
            visual.orbGlow.bobSpeed = 2.1f;
