...
| `10. Build Parry Recording Stages` | `Editor/ParryRecordingStageFactory.cs` | Idempotently writes four isolated LevelDefinition assets under `Assets/Data/Levels/Recording/`: flat, downhill, ice/water and mixed traversal. They contain no shooters; record a desired rhythm first, then generate an encounter module in Level Studio. |
